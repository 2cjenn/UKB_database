...
class DoFile:
    ...
    def __init__(self, data_cols: pd.Series,
                 do_file: str = "K:/TEU/UKB33952_Data/Data_Downloads/V5.0_B2015010_R48850/Stata/ukb48850.do",
                 dct_file: str = "K:/TEU/UKB33952_Data/Data_Downloads/V5.0_B2015010_R48850/Stata/ukb48850.dct"):
...
class Fields:
    ...
    def write_query(self, tblname: str = "ukb48850", max_cols: int = 1000,
...
def main(field_list: str = "C:/Users/jenniferco/My Documents/pythonStata/hearingfields.txt",
         out_file: str = "test.dta",
         out_do: str = "test.do",
         max_cols: int = 1000,
         db_name: str = "K:/TEU/UKB33952_Data/Data_Downloads/V5_database_duckdb0.3.0/ukb_v5_stata.db",
         tblname: str = "ukb48850",
         do_file: str = "K:/TEU/UKB33952_Data/Data_Downloads/V5.0_B2015010_R48850/Stata/ukb48850.do",
         dct_file: str = "K:/TEU/UKB33952_Data/Data_Downloads/V5.0_B2015010_R48850/Stata/ukb48850.dct"):
...
if __name__ == "__main__":
    ...
    parser.add_argument('db_name', type=str,
                        ...
                        default="K:/TEU/UKB33952_Data/Data_Downloads/V5_database_duckdb0.3.0/ukb_v5_stata.db")
    ...
    parser.add_argument('do_file', type=str,
                        ...
                        default="K:/TEU/UKB33952_Data/Data_Downloads/V5.0_B2015010_R48850/Stata/ukb48850.do")
    parser.add_argument('dct_file', type=str,
                        help='Path to the .dct file generated by ukbconv for the data download',
                        default="K:/TEU/UKB33952_Data/Data_Downloads/V5.0_B2015010_R48850/Stata/ukb48850.dct")
