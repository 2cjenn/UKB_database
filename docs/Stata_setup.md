...
* Install [miniconda](https://docs.conda.io/en/latest/miniconda.html)
  ...
  * If you don’t have admin access to our computers, you won’t be allowed to install in Program Files. Recommend C:\Users\<username>\Miniconda3

* Open an Anaconda prompt (start menu, “Anaconda”)
